...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleEnrollmentNotFound(
        ...
        ProblemDetail problem = buildProblemDetail(
                HttpStatus.NOT_FOUND, "Appointment Not Found", ex.getMessage(), request.getRequestURI());
    ...
    public ResponseEntity<ProblemDetail> handleDoctorServiceException(
        ...
        ProblemDetail problem = buildProblemDetail(
                ...
                "Unable to validate doctor slot. Please ensure the doctor slot ID is valid and try again.",
                request.getRequestURI());
        return problemResponse(HttpStatus.BAD_GATEWAY, problem);
    }
